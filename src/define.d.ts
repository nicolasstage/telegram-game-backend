...
declare type WorkerCommandError =
  | "NOT_READY"
  | "INVALID_DATA"
  | "NO_UUID"
  | "INVALID_COMMAND"
  | "OPENPGP_RUNNING_ERROR"
  | "TIMEOUT"
  | "PouchDB_ERROR"
  | "GENERATE_PASSCODE_ERROR"
  | "FAILURE"
  | "COUNTDOWN"
  | netWorkError
  | verification
...
declare type netWorkError =
  ...
  | "UNKNOW_ERROR"
  | "LOCAL_RESPONE_NO_JSON_DATA";

declare type seguroError =
  | "TIMEOUT_EMAIL_SERVER"
  | "TIMEOUT_SEGURO_NETWORK"
  | "NO_INTERNET"
  | "CONNECTING_ACCESS_POINT"
  | "CONNECTING_SEGURO_NETWORK"
  | "INIT"
  | "NOT_STRIPE"
  | "LOCAL_SERVER_ERROR"
  | "INVITATION_CODE_ERROR"
  | "SEGURO_DATA_FORMAT_ERROR"
  | "SEGURO_ERROR";
