...
const dailyCheckInAbi = [
  ...
  },
  {
    ...
    name: "changeCurrentTicketNftAssetNumber",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  {
    inputs: [],
    name: "currentTicketNftAssetNumber",
    outputs: [
      {
        internalType: "uint256",
        name: "",
